  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return (profiles || []).map(profile => ({
        ...
        transfer_pin: profile.transfer_pin ?? null,
        is_transfer_restricted: profile.is_transfer_restricted ?? false,
        transfer_restriction_message: profile.transfer_restriction_message ?? null,
